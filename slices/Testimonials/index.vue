...
const testimonials = computed(() => {
  return props.slice.primary.testimonials.map(item => item.testimonial).filter(testimonial => isFilled.contentRelationship(testimonial)) as unknown as Content.TestimonialDocument[];
})
</script>
